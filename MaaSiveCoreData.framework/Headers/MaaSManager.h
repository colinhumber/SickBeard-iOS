 ...
 */
- (NSDictionary *) callService:(NSString *) service command:(NSString *) command parameters:(NSDictionary *) parameters error:(NSError **) error;
 ...
 */
- (void) callService:(NSString *) service command:(NSString *) command parameters:(NSDictionary *) parameters completionBlock: (void (^)(NSDictionary *results, NSError *error)) block;
